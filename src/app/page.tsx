        ...
        <main className="main absolute left-0 top-0 z-10 w-full min-h-screen ">
          ...
          <div className="section-1 pt-32 pb-20 px-16 min-h-screen flex flex-col justify-between mix-blend-difference ">
            <div className="overflow-hidden">
              <h1 className="first-block-el translate-y-[11rem] opacity-0 uppercase text-[13rem]/[1] sm:text-[15rem]/[11.5rem] ">
                {/* <h1 className="first-block-el translate-y-[11rem] opacity-0 uppercase text-[10rem]/[1] sm:text-[10rem]/[1] font-semibold "> */}
                So Coffee Roasters
              </h1>
            </div>
